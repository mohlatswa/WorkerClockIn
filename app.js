...
function renderPayslipRow(p) {
  return '<div class="lv-row">' +
    '<div style="flex:1;min-width:0">' +
      ...
      '<div class="sub" style="font-size:.77rem">' + (p.gross != null ? fmtR(+p.gross) + ' · ' : '') +
  ...
  win.document.write('<!DOCTYPE html><html><head><meta charset="utf-8"><title>Payslip — ' + esc(w.name || '') + ' — ' + esc(p.period_label) + '</title>' +
    ...
    '<div class="sheet">' +
      ...
      '<div class="body">' +
        ...
        '</tbody>' +
        '<tfoot><tr class="sub-tot"><td>Total</td><td class="r">' + totalHrs.toFixed(2) + '</td><td></td><td class="r">' + fmtR(gross) + '</td></tr></tfoot>' +
        '</table>' +
        '<div class="summary"><div class="netbox">' +
          '<div class="line"><span>Gross earnings</span><span>' + fmtR(gross) + '</span></div>' +
          '<div class="grand"><span class="lbl">GROSS PAY</span><span class="amt">' + fmtR(gross) + '</span></div>' +
        '</div></div>' +
        '<div class="note">This statement reflects <b>gross earnings</b> calculated from recorded attendance. ' +
          'Statutory deductions (PAYE, UIF) are not calculated by WorkClock-In and must be applied by your employer where applicable.<br>' +
